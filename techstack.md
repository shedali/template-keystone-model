...
## Tech Stack
shedali/template-keystone-model is built on the following main stack:
...
# Tech Stack File
![](https://img.stackshare.io/repo.svg "repo") [shedali/template-keystone-model](https://github.com/shedali/template-keystone-model)![](https://img.stackshare.io/public_badge.svg "public")
<br/><br/>
...
|:------|:------|:------|:------|:------|:------|
|[npm-run-all](https://www.npmjs.com/npm-run-all)|v4.1.5|02/08/23|Franz |MIT|N/A|
|[tsc-watch](https://www.npmjs.com/tsc-watch)|v6.0.0|02/08/23|Franz |MIT|N/A|
